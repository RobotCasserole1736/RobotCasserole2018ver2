...
class CasseroleVision:
    ...
    def __init__(self):
        ...
        self.frame_dec_factor = 4 #At 60FPS, this still delivers 15FPS to the driver
    ...
    def processCommon(self, inframe, outframe):
        ...
        if(self.tgtAvailable == True):
            ...
            self.tgtXLoc = best_target.X
            self.tgtYLoc = best_target.Y
            self.tgtboundedArea = best_target.boundedArea
        else:
            self.tgtXLoc = 0
            self.tgtYLoc = 0
            self.tgtboundedArea = 0
        ...
        pipeline_delta_t = pipeline_end_time - pipline_start_time
        self.pipelineDelay_us = pipeline_delta_t.microseconds
        ...
        jevois.sendSerial("{{{},{},{},{},{},{},{},{},{}}}\n".format(self.frame,("T" if self.tgtAvailable else "F"),self.tgtXLoc, self.tgtYLoc, self.tgtboundedArea ,self.framerate_fps,self.CPULoad_pct,self.CPUTemp_C,self.pipelineDelay_us))
